...
summon firework_rocket ~ ~ ~ {Silent:1b,NoGravity:0b,Life:0,LifeTime:0,Motion:[0.0,0.5,0.0],Tags:["d1","cluster","in.holy_wrath_firework"],FireworksItem:{id:"firework_rocket",count:1,components:{fireworks:{explosions:[{shape:'burst',colors:[16777215],fade_colors:[16774502]},{shape:'burst',colors:[16774502],fade_colors:[16777215]}]}}}}
