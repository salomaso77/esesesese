...
summon minecraft:firework_rocket ~ ~1 ~ {Tags:["in.castle_firework_init"],Silent:0b,Motion:[0.0,0.0,0.0],ShotAtAngle:1b,LifeTime:50,FireworksItem:{id:"firework_rocket",count:1,components:{fireworks:{flight_duration:1,explosions:[{shape:'burst',has_twinkle:false,has_trail:false,colors:[6710886]},{shape:'burst',has_twinkle:false,has_trail:false,colors:[3355443]},{shape:'burst',has_twinkle:false,has_trail:false,colors:[0]}]}}}}
