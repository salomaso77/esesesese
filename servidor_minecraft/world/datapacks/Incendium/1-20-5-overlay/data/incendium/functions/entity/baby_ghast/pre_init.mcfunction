...
execute at @s run summon minecraft:ghast ~ ~ ~ {Invulnerable:true,Attributes:[{Base:0.1d, Name:"generic.scale"}],Tags:["in.baby_ghast"],Passengers:[{id:"minecraft:allay",Tags:["in.baby_head"]}]}
