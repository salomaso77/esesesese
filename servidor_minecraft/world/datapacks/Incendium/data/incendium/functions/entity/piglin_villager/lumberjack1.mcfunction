...
data modify entity @s ArmorItems set value [{}, {}, {Count:1b, id:"minecraft:chainmail_chestplate", tag:{Damage:0}}, {}]
data modify entity @s HandItems set value [{Count:1b, id:"minecraft:golden_axe", tag:{Damage:0}}, {}]
