...
summon firework_rocket ~ ~ ~ {CustomNameVisible:0b,LifeTime:1,CustomName:'{"translate":"Project\'s Death Event","color":"green"}',FireworksItem:{id:firework_rocket,Count:1,components:{"minecraft:fireworks":{explosions:[{shape:"large_ball",colors:[I;16715061],fade_colors:[I;15087886],has_trail:1b,has_twinkle:1b}]}}}}
