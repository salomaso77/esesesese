...
summon item ~ ~ ~ {Item:{id:"minecraft:feather",Count:1b,components:{"minecraft:custom_name":"{\"text\":\"Broken Compass\",\"color\":\"red\",\"italic\":false}","minecraft:custom_model_data":888501}}}
