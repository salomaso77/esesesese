...
execute if data storage bracken:var {splinters.potion_contents:{}} as @s anchored eyes positioned ^ ^ ^ run function bracken:player/enchantment/splintering/summon_arrows_macro with storage bracken:var splinters
execute unless data storage bracken:var {splinters.potion_contents:{}} as @s anchored eyes positioned ^ ^ ^ run function bracken:player/enchantment/splintering/summon_tipped_arrows_macro with storage bracken:var splinters