...
attribute @s minecraft:player.entity_interaction_range modifier add bracken:enderling.range 0.15 add_multiplied_base
attribute @s minecraft:generic.scale modifier add bracken:enderling.scale 0.25 add_multiplied_base
