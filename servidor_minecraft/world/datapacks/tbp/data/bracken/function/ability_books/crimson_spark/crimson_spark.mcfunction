...
summon minecraft:firework_rocket ^ ^1.5 ^5 {Life:1,LifeTime:1,FireworksItem:{id:firework_rocket,Count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",colors:[I;16715061],fade_colors:[I;15087886],has_trail:1b}]}}}}
