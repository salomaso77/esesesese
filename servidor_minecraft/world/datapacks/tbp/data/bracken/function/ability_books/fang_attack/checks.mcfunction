...
execute if data storage bracken:config {ability_books_on: true} if entity @s[level=2..] run function bracken:ability_books/fang_attack/fang_attack
...
scoreboard players set @s OMNI.POWER.fang_attack 0
scoreboard players set @s _OMNI.POWER.fang_attack 1
