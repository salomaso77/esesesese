...
attribute @s minecraft:generic.safe_fall_distance modifier remove bracken:omni_safefall
attribute @s minecraft:player.block_interaction_range modifier remove bracken:omni_blockrange
