...
execute if score @s bp.brine_potion matches 101 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"},{closed_path:"enhance"}],CustomPotionEffects:[{Duration:9600,Id:30},{Duration:9600,Id:29}]}}
execute if score @s bp.brine_potion matches 102 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"},{astral:2b},{closed_path:"enhance"}],CustomPotionEffects:[{Duration:800,Id:24,Amplifier:0}]}}
execute if score @s bp.brine_potion matches 103 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"},{closed_path:"enhance"}],CustomPotionEffects:[{Duration:600,Id:15}]}}
execute if score @s bp.brine_potion matches 104 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"},{greed_duration:1b},{greed_amplifier:0b}],CustomPotionEffects:[{Duration:4800,Id:26,Amplifier:0}]}}
...
execute if score @s bp.brine_potion matches 107 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"},{closed_path:"enhance"}],CustomPotionEffects:[{Duration:600,Id:9}]}}
